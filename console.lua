--rewrite by onyx for me
--original coder - Team STK
do
...
function Console:Window(consoledebugger)
    ...
    -- Создание кнопки Start Session
    StartSessionButton.Name = "StartSessionButton"
    StartSessionButton.Parent = Window
    StartSessionButton.BackgroundColor3 = Color3.fromRGB(58, 58, 58)
    StartSessionButton.BorderSizePixel = 0
    StartSessionButton.Position = UDim2.new(0, 350, 0, 11)
    StartSessionButton.Size = UDim2.new(0, 100, 0, 20)
    StartSessionButton.ZIndex = 3
    StartSessionButton.Font = Enum.Font.GothamSemibold
    StartSessionButton.Text = "Start Session"
    StartSessionButton.TextColor3 = Color3.fromRGB(220, 220, 220)
    StartSessionButton.TextSize = 14.000
    
    StartSessionButtonUICorner.CornerRadius = UDim.new(0, 4)
    StartSessionButtonUICorner.Name = "StartSessionButtonUICorner"
    StartSessionButtonUICorner.Parent = StartSessionButton
    ...
    StartSessionButton.MouseButton1Click:Connect(function()
        ConsoleLog:Prompt({
